...
## Installation
1. Download the [latest release](https://github.com/Oneweys/FanControl.LenovoYoga-7/releases/latest/download/FanControl.LenovoYoga-7.zip), or browse all [Releases](https://github.com/Oneweys/FanControl.LenovoYoga-7/releases).
