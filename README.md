...
## Installation
1. Dowload the [lastest](/releases/latest/download/FanControl.LenovoYoga.zip), or browse all [Releases](https://github.com/Oneweys/FanControl.LenovoYoga-7/releases).
